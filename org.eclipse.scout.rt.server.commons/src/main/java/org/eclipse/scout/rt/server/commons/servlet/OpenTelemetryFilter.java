...
import static org.eclipse.scout.rt.server.commons.opentelemetry.OpenTelemetryFilterInstrumenterFactory.createInstrumenter;
import static org.eclipse.scout.rt.shared.opentelemetry.OpenTelemetryInstrumenterHelper.*;
...
public class OpenTelemetryFilter implements Filter {
  ...
  public void doFilter(ServletRequest request0, ServletResponse response0, FilterChain chain) throws IOException, ServletException {
    ...
    parentContext = parentContext.with(NAME_CONTEXT_KEY, new ArrayList<>());
