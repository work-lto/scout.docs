...
@ApplicationScoped
public class ServiceTunnelServletInstrumenterFactory {
  public static final String INSTRUMENTATION_NAME = "server.ServiceTunnelServlet";

  public static Instrumenter<ServiceTunnelRequest, ServiceTunnelResponse> createInstrumenter() {
    SpanNameExtractor<ServiceTunnelRequest> spanNameExtractor = serviceTunnelRequest -> {
      ...
      return serviceName + "." + serviceTunnelRequest.getOperation();
    };
    AttributesExtractor<ServiceTunnelRequest, ServiceTunnelResponse> attributesExtractor = new AttributesExtractor<>() {
      ...
      @Override
      public void onEnd(AttributesBuilder attributes, Context context, ServiceTunnelRequest serviceTunnelRequest, @Nullable ServiceTunnelResponse serviceTunnelResponse, @Nullable Throwable error) {
        // nop
      }
    };
    return Instrumenter.<ServiceTunnelRequest, ServiceTunnelResponse> builder(GlobalOpenTelemetry.get(),
